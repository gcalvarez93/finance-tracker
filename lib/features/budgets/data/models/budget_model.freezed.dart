...
class _$BudgetModelImpl implements _BudgetModel {
  ...
  @override
  String toString() {
    return 'BudgetModel(id: $id, categoryId: $categoryId, categoryName: $categoryName, categoryIcon: $categoryIcon, amount: $amount, spent: $spent, month: $month, createdAt: $createdAt)';
  }
